...
public class FXMLAnchorPaneProcessosVendasDialogController implements Initializable {
    ...
    public void setVenda(Venda venda) {
        this.venda = venda;
        this.comboBoxVendaCliente.getSelectionModel().select(venda.getCliente());
        this.datePickerVendaData.setValue(venda.getData());
        this.checkBoxVendaPago.setSelected(venda.getPago());
